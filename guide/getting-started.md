...
`examples/demo-agentos` is a real AgentOS `3.0.10` with agents, teams and workflows that exercise
...
`.env` is gitignored and optional — a shell-exported `OPENAI_API_KEY` works the same way and takes
